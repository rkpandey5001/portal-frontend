  ...
  return (
    <div>
      <div className="text-center">
        <div className="flex flex-col gap-5 md:my-10 xsm:my-40">
          <span className="mx-auto px-4 py-2  bg-gray-100 text-[#F83002] font-medium ">
            No. 1 Job Search Website
          </span>
          <h1 className="md:text-5xl font-bold sm:text-2xl">
            Search, Apply & <br /> Get Your{" "}
            <span className="text-[#6A38C2]">Dream Jobs</span>
          </h1>
          <p className="w-[65%] m-auto xsm:text-justify">
          ...
          <div className="flex xsm:w-[80%] md:w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto mt-3">
            <input
              type="text"
