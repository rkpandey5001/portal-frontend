...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${USER_API_END_POINT}/login`, input, {
        headers: {
  ...
  return (
    <div className="flex items-center justify-center max-w-7xl mx-auto">
      <form
        className="sm:w-[70%] md:w-[40%] border border-gray-200 rounded-md p-4 xsm:my-40 md:my-12"
      ...
      >
        ...
        <span className="text-sm flex items-center justify-center">
          Not an account?{" "}
          <Link to="/signup" className="text-blue ml-2 font-bold">
            Sign Up
          </Link>
        </span>
      </form>
